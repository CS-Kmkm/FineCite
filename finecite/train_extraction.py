...
def get_args():
    ...
    parser.add_argument(
        "--model_name", type=str, default="scibert", help="Model type: scibert, llm2vec_mistral, or llm2vec_llama3"
    )

    parser.add_argument(
        "--ext_type", type=str, default="bilstm_crf", help="Extension type: linear, bilstm, crf, or bilstm_crf"
    )

    parser.add_argument("--iob_labels", action="store_true", help="Use IOB labels if set (default: False)")
    ...
    parser.add_argument("--debug_size", type=int, default=100, help="Number of examples to load in debug mode")

    parser.add_argument("--seed", type=int, default=4455, help="Random seed")
